...
**GitHub**: [https://github.com/emmalone/OppManagement](https://github.com/emmalone/OppManagement)
...
### [README.md]({{< relref "/documents/OppManagement/README" >}})

A desktop application for managing and visualizing your sales pipeline with an interactive bubble chart.

### [claude.md]({{< relref "/documents/OppManagement/claude" >}})

**Desktop Application for Sales Pipeline Management & Visualization**

### [LICENSE.md]({{< relref "/documents/OppManagement/LICENSE" >}})
