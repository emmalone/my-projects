...
- [SECURITY_REVIEW.md](klm-hugo-site/SECURITY_REVIEW.md)
  - **Date:** December 28, 2025
- [WORKFLOW.md](klm-hugo-site/WORKFLOW.md)
  - Complete guide for working with the KLM Insurance Hugo site across multiple devices.
- [README.md](klm-hugo-site/README.md)
  - Migrate website to hugo on aws
- [SIDEBAR_IMAGES_NEEDED.md](klm-hugo-site/SIDEBAR_IMAGES_NEEDED.md)
  - This document lists the sidebar images that need to be sourced from royalty-free image sites.
- [claude.md](klm-hugo-site/claude.md)
  - **Complete Project Context & Technical Reference**
- [NEW_PAGE_TEMPLATE_GUIDE.md](docs/NEW_PAGE_TEMPLATE_GUIDE.md)
  - **Last Updated:** December 22, 2025
- [PROJECT_COMPLETE.md](docs/PROJECT_COMPLETE.md)
  - **Date:** December 21, 2025
- [JOTFORM_INTEGRATION_SUMMARY.md](docs/JOTFORM_INTEGRATION_SUMMARY.md)
...
- [klm_crm_publishing_process.md](docs/klm_crm_publishing_process.md)
...
- [FORM_COMPLETE_FIX.md](docs/FORM_COMPLETE_FIX.md)
  - 1. ❌ Two blue borders (different shades)
- [FINAL_FORM_FIX_SUMMARY.md](docs/FINAL_FORM_FIX_SUMMARY.md)
  - To complete the fix and eliminate the white/gray bars on the sides, apply this updated CSS in JotForm Designer:
- [APPLY_CSS_MANUALLY.md](docs/APPLY_CSS_MANUALLY.md)
...
- [FIX_APEX_DOMAIN.md](docs/FIX_APEX_DOMAIN.md)
  - **Issue:** The apex domain `klmcrm.com` (without www) is not resolving to the staging site.
- [COMPACT_FORM_CSS.md](docs/COMPACT_FORM_CSS.md)
  - Go to: https://www.jotform.com/build/253585658329169
- [product-service-template.md](templates/product-service-template.md)
  - [Product/Service Name] - KLM Insurance Solutions
- [HOW_TO_USE_TEMPLATE.md](templates/HOW_TO_USE_TEMPLATE.md)
  - **Complete guide for using the KLM Insurance product/service template**
- [example-renters-insurance.md](templates/example-renters-insurance.md)
...
- [contact.md](klm-hugo-site/content/contact.md)
  - Contact us for insurance quotes and questions
- [client-center.md](klm-hugo-site/content/client-center.md)
  - Access your insurance policies and manage your account
- [boat-insurance.md](klm-hugo-site/content/boat-insurance.md)
  - Boat/Watercraft Insurance - KLM Insurance Solutions
- [term-whole-permanent-insurance.md](klm-hugo-site/content/term-whole-permanent-insurance.md)
  - Understanding the key differences between Term, Whole, and Permanent Life Insurance - KLM Insurance Solutions
- [home-insurance.md](klm-hugo-site/content/home-insurance.md)
  - Home Insurance - KLM Insurance Solutions
- [umbrella-insurance.md](klm-hugo-site/content/umbrella-insurance.md)
  - Umbrella Insurance - KLM Insurance Solutions
- [life-insurance.md](klm-hugo-site/content/life-insurance.md)
  - Life Insurance - KLM Insurance Solutions
- [compare-quotes.md](klm-hugo-site/content/compare-quotes.md)
  - Compare insurance quotes from multiple carriers
- [auto-insurance.md](klm-hugo-site/content/auto-insurance.md)
  - Auto Insurance - KLM Insurance Solutions
- [about.md](klm-hugo-site/content/about.md)
  - About KLM Insurance Solutions, Inc - KLM Insurance Solutions
- [_index.md](klm-hugo-site/content/_index.md)
  - High-quality, reliable insurance coverage options in Pennsylvania
- [MIGRATE_TO_GITHUB_CHECKLIST.md](klm-hugo-site/docs/MIGRATE_TO_GITHUB_CHECKLIST.md)
  - **Navigate to your project directory and look for:**
- [DEVELOPMENT_WORKFLOW.md](klm-hugo-site/docs/DEVELOPMENT_WORKFLOW.md)
  - **Updated:** The workflow has been reconfigured for 3 distinct development scenarios:
- [SESSION_HANDOFF.md](klm-hugo-site/docs/SESSION_HANDOFF.md)
  - **Date:** December 28, 2025
- [DEPLOYMENT.md](klm-hugo-site/docs/DEPLOYMENT.md)
